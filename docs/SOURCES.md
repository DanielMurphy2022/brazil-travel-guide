...
All fourteen photographs come from Wikimedia Commons and are reused under the Creative
Commons licence shown. Attribution is also printed on the Destinations page of the
site itself, which is what these licences require, with the title linking to the file
page and the licence name linking to the licence.
